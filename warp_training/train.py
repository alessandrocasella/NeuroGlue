...
if __name__ == '__main__':
    ...
    opt.eval_output_dir = r"/home/amdeluca/warp_training/training_SGresults/"
    # opt.train_path = r"/home/nearlab/Thesis_Anna_De_Luca/SuperGlue-TRAINING/patches_FINAL/"
    opt.train_path = "/home/amdeluca/warp_training/final_patches_video1/"
    # opt.train_path = r"/home/nearlab/Thesis_Anna_De_Luca/SuperGlue-TRAINING/Frames_cut/"
    opt.viz = True
    ...
    for epoch in range(1, opt.epoch+1):
        ...
        model_out_path = "model_epoch_{}.pth".format(epoch)
        weights_out_path = "weights_epoch_{}.pth".format(epoch)
        torch.save(superglue, model_out_path)
        ...
        print("Epoch [{}/{}] done. Epoch Loss {}. Weights saved to {}".format(epoch, opt.epoch, epoch_loss, weights_out_path))
        ...
        # torch.onnx.export(superglue, dummy_input, model_out_path, verbose=True, input_names=input_names,output_names=output_names)
